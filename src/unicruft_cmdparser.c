...
{
  printf("unicruft (%s %s) by Bryan Jurish <jurish@bbaw.de>\n", PACKAGE, VERSION);
}
...
cmdline_parser_print_help (void)
{
  ...
  printf("\n");
  printf(" Arguments:\n");
  printf("   FILE(s)  Input text file(s)\n");
...
{
  args_info->mode_arg = gog_strdup("ua"); 
